...
const TopNav = () => {
  ...
  return (
    <header className="z-[99] lg:sticky fixed top-0 right-0 flex w-[100%] bg-black border-[#FF6000] backdrop-blur-xl lg:border-b shadow-sm">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          <button
            className="items-center justify-center w-10 h-10 text-[#FF6000] border-[#FF6000] rounded-lg lg:flex lg:h-11 lg:w-11 lg:border hover:bg-[#FF6000] transition-colors hover:text-[#000]"
          ...
          <button
            ...
            className="flex items-center justify-center w-10 h-10 text-[#FF6000] rounded-lg hover:bg-[#FFF] transition-colors lg:hidden"
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
              <path
                fillRule="evenodd"
        ...
        <div
          className={`${isApplicationMenuOpen ? "flex" : "hidden"
            } items-center justify-between w-full gap-4 px-5 py-4 lg:flex shadow-sm lg:justify-end lg:px-0 lg:shadow-none bg-[#FF6000] lg:bg-transparent`}
        >
