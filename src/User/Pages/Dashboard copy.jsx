...
import banner1 from "../../assets/userImages/images/banner1.png";
import banner2 from "../../assets/userImages/images/banner2.png";
...
const Dashboard = () => {
      ...
      return {
        ...
        wallets: {
          ...
          totalReadyInvestment: data.data.wallets?.totalReadyInvestment
            ...
            : "$0.00",
          totalUnderconstructionInvestment: data.data.wallets
            ?.totalUnderconstructionInvestment
            ? `${Number(
  ...
  const parsedEarningTimes =
    typeof earningTimes === "string"
      ? parseFloat(earningTimes.replace("X", ""))
      : parseFloat(earningTimes);
  const shouldShowButton =
    earningTimes === "2.00X" ||
    (!isNaN(parsedEarningTimes) &&
      parsedEarningTimes >= 1.98 &&
      parsedEarningTimes <= 2.0);
  ...
  return (
    <div className="text-white p-0 overflow-x-hidden bg-black">
      {/* Header */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          <h1 className="text-2xl uppercase text-[#FF6000] font-bold">
        ...
        <div className="flex items-center gap-4">
          {shouldShowButton && (
            <button
              className="flex animate-pulse items-center gap-2 px-4 py-2 bg-[#FF6000] rounded-lg transition-colors pulse-animation"
          ...
          <button
            type="button"
            className="group relative overflow-hidden px-6 py-2 rounded-xl text-white font-semibold
  bg-gradient-to-r from-[#FF7A00] via-[#FF6000] to-[#E3090D]
  border border-[#ffcf99]/30
  shadow-[0_8px_0_#a12a00,0_14px_28px_rgba(255,102,0,0.35)]
  transition-all duration-300 ease-out
   hover:shadow-[0_6px_0_#a12a00,0_10px_20px_rgba(227,9,13,0.45)]
  hover:from-[#E3090D] hover:via-[#FF6000] hover:to-[#FF7A00]
  active:translate-y-[1px] active:shadow-[0_2px_0_#a12a00,0_6px_6px_rgba(255,102,0,0.25)]"
            onClick={() => open()}
          >
            ...
            <span className="absolute top-0 left-[-75%] h-full w-1/2 rotate-12 bg-white/20 blur-md transition-all duration-500 group-hover:left-[130%]"></span>
          </button>
        </div>
      </div>
      ...
      <div className="  gap-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 lg:col-span-2">
          {[
            ...
            {
              title: "Ready Investment",
              value: dashboardData.wallets?.totalReadyInvestment || "$0.00",
              color: "bg-[#FF6000]",
              icon: <FaDollarSign className="text-white" />,
            },
            {
              title: "Undercons Investment",
              value:
                dashboardData.wallets?.totalUnderconstructionInvestment ||
                "$0.00",
              color: "bg-[#FF6000]",
              icon: <FaDollarSign className="text-white" />,
            },
            {
              title: "Tokenized Investment",
              value: dashboardData.wallets?.totalTokenizedInvestment || "$0.00",
              color: "bg-[#FF6000]",
              icon: <FaDollarSign className="text-white" />,
            },
            ...
            // },
            // {
            //   title: "Total Binary Rewards",
            //   value: dashboardData.incomes?.totalBinaryRewards || "$0.00",
            //   color: "bg-[#FF6000]",
            //   icon: <FaDollarSign className="text-white" />,
            // },
            //  {
            //   title: "Total Leadership Bonuses",
            //   value: dashboardData.incomes?.totalLeadershipRewards || "$0.00",
            //   color: "bg-[#FF6000]",
            //   icon: <FaDollarSign className="text-white" />,
            // },
            // {
            ...
            // },
            // {
            //   title: "Binary Daily Cap",
            //   value: dashboardData.wallets?.binaryDailyCap || "N/A",
            //   color: "bg-[#FF6000]",
            //   icon: <FaDollarSign className="text-white" />,
            // },
            ...
            {
              title: "Leadership Shares",
              value: dashboardData.incomes?.leadershipShares || "0",
              color: "bg-[#FF6000]",
              icon: <FaDollarSign className="text-white" />,
            },
          ].map((item, idx) => (
            <div
              key={idx}
              className="theme-card-style  border-gradient p-4 rounded-xl  "
            >
          ...
          {[
            {
              name: "Deposit Wallet",
              balance: dashboardData.wallets?.depositWallet || "0.00",
            },
            {
              name: "My Wallet",
            ...
            {
              name: "SGN Wallet",
              balance: dashboardData.wallets?.emgtWallet || "0.00",
            },
            {
              name: "Referral Wallet",
              balance: dashboardData.wallets?.referralWallet || "0.00",
            },
            {
              name: "Total Withdraw",
              balance: dashboardData.transactions?.totalWithdraw || "0.00",
            },
          ].map((wallet, idx) => {
            return (
              <div key={idx} className="theme-card-style border-gradient p-4">
                <div className="flex flex-col-reverse gap-3 justify-between">
                  <h2 className="text-sm font-semibold flex items-center gap-2 text-white">
                    <FaWallet className="text-[#FF6000]" />
                    {wallet.name}
                  </h2>
                  <span className="text-xs text-white">Wallet {idx + 1}</span>
                </div>

                {wallet.name === "SGN Wallet" ? (
                  <div className="text-sm break-words   text-[#FF6000]">
                    ...
                    <span className="text-xs text-orange-400 ml-1">
                      ...
                      {(
                        ...
                        Number(dashboardData.tokenOverview?.price || 0)
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
        <div className="theme-card-style border-gradient p-6">
          <div className="mb-5">
            <h3 className="text-lg font-semibold text-[#FF6000] mb-2">
              TOTAL INCOMES
            </h3>
          ...
          <div className="flex justify-center mb-4">
            <div className="relative">
              <div className="w-44 h-44 bg-gradient-to-br from-[#FF6000] to-[#E3090D] rounded-full flex items-center justify-center">
...
<<<<<<< HEAD
            <div
              className={`w-8 h-8 bg-[#FF6000] mb-3 rounded-full flex items-center justify-center`}
            >
              <FaUsers className="text-white" />
            </div>
            <h3 className="text-lg font-semibold text-[#FF6000] mb-4">
              REFERRAL LINK
            </h3>
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 bg-[#FF6000] rounded-lg p-3">
              <input
                type="text"
                value={dashboardData.referralLink}
                readOnly
                className="flex-1 bg-transparent text-white font-[300] text-sm outline-none w-full sm:w-auto"
              />
              <button
                onClick={handleCopy}
                className="bg-black mt-3 sm:mt-0 hover:bg-[#E3090D] border px-4 py-1 rounded text-sm transition-colors"
              >
                {copied ? "Copied!" : "Copy"}
              </button>
            </div>
...
=======
  <div className="w-8 h-8 bg-[#FF6000] mb-3 rounded-full flex items-center justify-center">
    <FaUsers className="text-white" />
  </div>
  ...
  {/* Change here */}
  <div className="flex flex-col items-center gap-3 bg-[#FF6000] rounded-lg p-3">
    
    <input
      type="text"
      value={dashboardData.referralLink}
      readOnly
      className="w-full bg-transparent text-white font-[300] text-sm outline-none text-center"
    />

  <button
  onClick={handleCopy}
  className="text-white px-6 py-1 rounded text-sm 
  border border-white
  bg-gradient-to-r from-[#FF6000] to-[#E3090D] 
  hover:from-[#E3090D] hover:to-[#FF6000] 
...
>>>>>>> ce7c0359d0eb491b6515484cbaa8a881533fd8a2
              ...
              {[
                {
                  ...
                  value: dashboardData.teamBusiness?.directBusiness || "$0.00",
                },
                {
                  text: "Total Team Business",
                  value:
                    dashboardData.teamBusiness?.totalTeamBusiness || "$0.00",
                },
                {
                  text: "Today Team Business",
                  value:
                    dashboardData.teamBusiness?.todayTeamBusiness || "$0.00",
                },
              ].map((item, idx) => (
                <div key={idx} className="flex justify-between items-center">
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 bg-[#FF6000] rounded-full flex items-center justify-center">
        ...
        <div className="theme-card-style border-gradient p-6">
          ...
          <div className="space-y-2 text-sm">
            {[
              {
                label: "Investment",
                value: dashboardData.profitTracker?.investment || "$0.00",
              },
              {
              ...
              },
              {
                label: "ROI + Level",
                value:
                  dashboardData.profitTracker?.earningWithoutCap || "$0.00",
              },
              {
                label: "Earnings Times",
                value: dashboardData.profitTracker?.earningTimes || "$0.00",
              },
            ].map((item, idx) => (
              <div key={idx} className="flex justify-between">
                <span className="">{item.label}</span>
          ...
          <div className="flex mt-10 justify-center mb-4">
            <div className="relative w-44 h-44 rounded-full">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-20 h-20 bg-gradient-to-br from-[#FF6000] to-[#E3090D] rounded-full flex items-center justify-center">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-6">
        <div className="theme-card-style border-gradient p-6 flex flex-col justify-center text-center">
          <div
            className={`w-full mb-4 h-14 mx-auto bg-gradient-to-br from-[#FF6000] to-[#E3090D] rounded-md flex items-center justify-center`}
          >
          ...
          <p className="text-sm text-white">Total Investment</p>
          <p className="text-2xl font-bold">
            {dashboardData.wallets?.totalInvestment || "$0.00"}
          </p>
        </div>
        ...
        <div className="theme-card-style border-gradient p-6 flex flex-col justify-center">
          <div className="grid grid-cols-2 gap-4 text-center">
            <div className="space-y-4">
              <div
                className={`w-full h-14 mx-auto bg-gradient-to-br from-[#FF6000] to-[#E3090D] rounded-md flex items-center justify-center`}
              >
                <MdOutlineCalendarMonth className="text-2xl text-white" />
              </div>
              <p className="text-sm text-white">Monthly ROI Income</p>
              <p className="text-xl font-bold">
                {dashboardData.incomes?.monthlyIncome || "$0.00"}
              </p>
            </div>
            <div className="space-y-4">
              <div
              ...
              <p className="text-sm text-white">Daily ROI Income</p>
              <p className="text-xl font-bold">
                {dashboardData.incomes?.dailyIncome || "$0.00"}
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mt-6 text-center">
        {[
          {
            title: "Total Team",
            value: dashboardData.teamStats?.totalTeam || 0,
            icon: <FaPeopleGroup className="text-2xl text-white" />,
          },
          {
            title: "My Direct",
            value: dashboardData.teamStats?.myDirect || 0,
            icon: <BsMicrosoftTeams className="text-2xl text-white" />,
          },
          {
            title: "Indirect",
            value: dashboardData.teamStats?.indirect || 0,
            icon: <FaPeopleArrows className="text-2xl text-white" />,
          },
        ].map((label, idx) => (
          <div key={idx} className="theme-card-style border-gradient p-6">
            <div
              className={`w-14 mb-4 h-14 mx-auto bg-gradient-to-br from-[#FF6000] to-[#E3090D] rounded-xl flex items-center justify-center`}
            >
              {label.icon}
            </div>
        ...
        <div className="theme-card-style border-gradient lg:col-span-2 p-6 text-center">
          ...
          <p className="text-lg font-bold mb-1">Shagun Pro Token Price</p>
          <p className="text-dark-300 text-sm">
            1 Shagun = USD {dashboardData.tokenOverview?.price || "0"}
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-6">
        <div className="relative theme-card-style border-gradient lg:col-span-4 p-6">
          <div className="absolute right-0 top-0">
            <BiSolidOffer className="text-[6rem] text-[#FF6000]" />
          </div>
          <div className="flex items-center gap-4">
            <div
              className={`w-14 mb-4 h-14 glow-text bg-gradient-to-br from-[#FF6000] to-[#E3090D] rounded-full flex items-center justify-center`}
            >
              <GrAnnounce className="text-2xl" />
            </div>
            <h3 className="text-lg font-semibold glow-text text-[#FF6000] mb-4">
              LATEST ANNOUNCEMENT
            </h3>
          </div>
          <h4 className="text-xl   font-bold mb-4">
            Empowering Decentralized Income with Shagun Pro
          </h4>
          <p className="   text-sm leading-relaxed">
            Shagun Pro Project is a next-gen blockchain-based MLM (Multi-Level
        ...
        {/* <div className="theme-card-style border-gradient p-6 text-center">
          ...
          <div className="text-white font-[400] mb-2">
            {dashboardData.userRank || "N/A"}
          </div>
          <button
            className="bg-[#E3090D] hover:bg-[#FF6000] text-white py-2 px-4 rounded text-sm"
