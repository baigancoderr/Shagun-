...
const Dashboard = () => {
  ...
  return (
    <div className="text-white p-0 overflow-x-hidden bg-black">
      ...
      <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center mb-8 gap-4">
        ...
        <div className="flex flex-col xs:flex-col sm:flex-row gap-6 w-full sm:w-auto">
          {shouldShowButton && (
            <button
              className="flex animate-pulse items-center gap-4 px-4 py-2 bg-[#FF6000] rounded-lg transition-colors pulse-animation"
  ...
  bg-gradient-to-r from-[#00C9FF] via-[#0072FF] to-[#0047AB]
  border border-[#99d6ff]/30
  shadow-[0_8px_0_#003a8c,0_14px_28px_rgba(0,114,255,0.35)]
  transition-all duration-300 ease-out
  hover:shadow-[0_6px_0_#003a8c,0_10px_20px_rgba(0,71,171,0.45)]
  hover:from-[#0047AB] hover:via-[#0072FF] hover:to-[#00C9FF]
  active:translate-y-[1px] active:shadow-[0_2px_0_#003a8c,0_6px_6px_rgba(0,114,255,0.25)]"
          >
          ...
          <button
            type="button"
            className="group relative overflow-hidden px-6 py-2 rounded-xl text-white font-semibold
  bg-gradient-to-r from-[#00FF9C] via-[#00C853] to-[#009624]
  border border-[#b9ffd9]/30
  shadow-[0_8px_0_#006d1b,0_14px_28px_rgba(0,200,83,0.35)]
  transition-all duration-300 ease-out
  hover:shadow-[0_6px_0_#006d1b,0_10px_20px_rgba(0,150,36,0.45)]
  hover:from-[#009624] hover:via-[#00C853] hover:to-[#00FF9C]
  active:translate-y-[1px] active:shadow-[0_2px_0_#006d1b,0_6px_6px_rgba(0,200,83,0.25)]"
          >
          ...
          {/* <div className="flex items-center gap-2 bg-[#FF6000] border px-4 py-2 rounded-lg">
            <div className="w-8 h-8 bg-[#E3090D] rounded-full flex items-center justify-center">
            ...
            <span className="text-sm">
              {dashboardData.userName} ({dashboardData.userRank})
            </span>
          </div> */}
      ...
      <div className="  gap-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4 lg:col-span-2">
          {[
            ...
            {
              title: "SGN Rate",
              value: dashboardData.tokenOverview?.price || "0",
              color: "bg-[#FF6000]",
              icon: <FaDollarSign className="text-white" />,
            },
            {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mt-6 text-center">
        ...
        <div className="theme-card-style border-gradient lg:col-span-2 p-6 text-center">
          ...
          <p className="text-dark-300 text-sm">
            1 SGN = USDT {dashboardData.tokenOverview?.price || "0"}
          </p>
        </div>
      </div>
