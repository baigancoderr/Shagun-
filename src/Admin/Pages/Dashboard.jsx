...
const Dashboard = () => {
  ...
  <button
     onClick={() => open()}
    className="flex items-center justify-center gap-2 bg-[#103944] hover:bg-[#0e2a33] text-white px-6 py-3 rounded-xl font-medium transition-all shadow-lg hover:shadow-xl active:scale-95 w-full sm:w-auto"
  >
